...
This version of the RStudio Launcher Plugin SDK is compatible with RStudio Server Pro v1.2.5000 or greater. To properly test the integration between an RStudio Launcher Plugin and RStudio Server Pro, an RStudio Server Pro license with the launcher feature enabled will be required. To acquire a license please contact sales@rstudio.com.
