...
knitr::include_graphics("images/sdk-arch.drawio.svg")
```
...
8. If higher level logging was requested, a file log destination is created in the scratch path location.
