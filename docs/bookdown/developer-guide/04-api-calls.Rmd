...
| RequestNotSupported | The request is not supported by the Plugin. The Plugin API component may return this if the Launcher is a supports a newer Launcher Plugin API version. | 1
