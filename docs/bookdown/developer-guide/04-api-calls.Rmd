...
| complete        | Whether the output stream is complete. Default: `true`.                                                                             | Boolean
...
| ipAddresses     | An array of the IP addresses for the machine running the job.                                                                       | String Array
