...
| valueType    | The type of the custom configuration value.                                 | "string", "int", "float", or "enum"
...
| defaultValue | One of the possible values of the placement constraint.                     | String 
| maxValue     | One of the possible values of the placement constraint.                     | String 
