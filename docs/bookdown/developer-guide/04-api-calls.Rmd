...
This type is JSON String value with limited set of valid values, rather than a JSON object like the other types described here. The possible values of a JobState field and their meanings are listed in the table below.
