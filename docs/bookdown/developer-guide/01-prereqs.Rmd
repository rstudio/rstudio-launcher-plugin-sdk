...
Plugins developed with the SDK require the RStudio Launcher to work. The SDK is currently compatible with the version of the RStudio Launcher that is shipped with RStudio Server Pro v1.4. As such, the SDK will be supported on all of the platforms supported by RStudio Server Pro v1.4, which can be found on the [RStudio Team Platform Support page](https://rstudio.com/about/platform-support/).
...
This version of the RStudio Launcher Plugin SDK is compatible with RStudio Server Pro v1.4 or greater. To properly test the integration between a Launcher Plugin and RStudio Server Pro, an RStudio Server Pro license with the launcher feature enabled will be required. To acquire a license please contact sales@rstudio.com.
