...
This example continues the examples started in the RStudio Launcher Plugin SDK QuickStart Guide. Assume that the Mars job scheduling system supports requesting a CPU count and an amount of memory, in MB.
...
class MarsUserProfiles : public options::AbstractUserProfiles
{
  public:
    ...
    uint32_t getDefaultCpus(const system::User& in_user)
    {
      // Default value is 1.
    ...
    uint32_t getMaxCpus(const system::User& in_user)
    {
      // Default value is 1.
      uint32_t maxCpus = 1;
    ...
    uint32_t getMaxMemory(const system::User& in_user)
    {
